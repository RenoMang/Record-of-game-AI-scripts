...
class Agent(AgentInterface):
    ...
    I think simulation on a systematic situation is useless, so I only simulation an expansion when its counts over 5. In the earlier select part, I only rely on my heuristic function.
